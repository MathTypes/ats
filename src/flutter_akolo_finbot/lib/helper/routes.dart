...
import 'package:flutter_akolo_finbot/ui/page/auth/verifyEmail.dart';
import 'package:flutter_akolo_finbot/ui/page/common/splash.dart';
import 'package:flutter_akolo_finbot/ui/page/feed/composeTweet/composeTweet.dart';
import 'package:flutter_akolo_finbot/ui/page/feed/composeTweet/state/composeTweetState.dart';
import 'package:flutter_akolo_finbot/ui/page/homePage.dart';
import 'package:flutter_akolo_finbot/ui/page/message/conversationInformation/conversationInformation.dart';
import 'package:flutter_akolo_finbot/ui/page/message/newMessagePage.dart';
import 'package:flutter_akolo_finbot/ui/page/profile/follow/followerListPage.dart';
import 'package:flutter_akolo_finbot/ui/page/search/SearchPage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/about/aboutTwitter.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/accessibility/accessibility.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/accountSettingsPage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/contentPrefrences/contentPreference.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/contentPrefrences/trends/trendsPage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/dataUsage/dataUsagePage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/displaySettings/displayAndSoundPage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/notifications/notificationPage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/privacyAndSafety/directMessage/directMessage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/privacyAndSafety/privacyAndSafetyPage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/accountSettings/proxy/proxyPage.dart';
import 'package:flutter_akolo_finbot/ui/page/settings/settingsAndPrivacyPage.dart';
