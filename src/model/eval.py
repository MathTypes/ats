...
if __name__ == "__main__":
    ...
    raw_predictions = best_tft.predict(val_dataloader, mode="raw", return_y=True, return_x=True)
    mean_losses = SMAPE(reduction="none")(raw_predictions.output, raw_predictions.y).mean(1)
