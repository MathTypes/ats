...
if test -f "$done_file"; then
    ...
    PYTHONPATH=. python3 ib/download_future_series.py $1  -p=4001 --start_date="20210101"  --end_date="20230331" --size="1 min" -t TRADES --base-directory="/Volumes/Seagate Portable Drive/data/trades" --security-type=FUT
    touch "$done_file"
fi
