...
@parameterize(
    kc_10_05={"close": source("close"), "high": source("high"), "low": source("low"), "window": value(10), "mult": value(0.5)},
    kc_10_10={"close": source("close"), "high": source("high"), "low": source("low"), "window": value(10), "mult": value(1.0)},
...
@parameterize(
    kc_10_05_high={"kc": source("kc_10_05")},
    kc_10_10_high={"kc": source("kc_10_10")},
    kc_10_15_high={"kc": source("kc_10_15")},
    kc_10_20_high={"kc": source("kc_10_20")},

    kc_10d_05_high={"kc": source("kc_10d_05")},
    kc_10d_10_high={"kc": source("kc_10d_10")},
    kc_10d_15_high={"kc": source("kc_10d_15")},
    kc_10d_20_high={"kc": source("kc_10d_20")},
...
@parameterize(
    kc_10_05_mid={"kc": source("kc_10_05")},
    kc_10_10_mid={"kc": source("kc_10_10")},
...
@parameterize(
    kc_10_05_low={"kc": source("kc_10_05")},
    kc_10_10_low={"kc": source("kc_10_10")},
    kc_10_15_low={"kc": source("kc_10_15")},
    kc_10_20_low={"kc": source("kc_10_20")},
