    ...
    # =================================================================================== #
        ...
        with st.container():
            ...
            if len(option) > 0:
                ...
                sen = nlp(text)
                visualize_ner(sen, title="", labels=nlp.get_pipe("ner").labels)
                ...
                st.info(
                    "Due to depolyment problem, I recommand to visualise this plot on the "
