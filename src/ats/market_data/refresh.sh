...
wget -O $TMPDIR/FUT/data.zip "https://firstratedata.com/api/data_file?type=futures&period=full&adjustment=contin_UNadj&timeframe=30min&userid=fg1LcNsv8kWWMJIt0caCFQ"
cd $TMPDIR/FUT
unzip data.zip
cd $rel_base_dir/../../..
