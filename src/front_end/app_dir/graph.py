...
class Visualization(Prediction):
    def __init__(self, interval, asset, action_model, price_model):
        ...
        logging.info(
            f"before get_prediction, action_model:{action_model}, price_model:{price_model}"
        )
    ...
    def prediction_graph(self, equity=None):
        ...
        if (
            self.df_visualization["Open"].iloc[-1]
            > self.df_visualization["Adj Close"].iloc[-1]
        ):
        ...
        self.fig_action.add_trace(
            go.Scatter(
                x=self.df_visualization.index,
                y=self.df_visualization["Adj Close"],
                name=f"Close Price ({price_tag})",
                connectgaps=False,
        ...
        prediction_title = "Price"
        self.fig_action.update_layout(
            autosize=False,
            height=350,
            dragmode=False,
            hovermode="x",
            ...
            xaxis_range=(
                self.df_visualization.index.min(),
                self.df_visualization.index.max(),
            ),
            yaxis_range=(
                self.df_visualization["Adj Close"].min()
                - self.df_visualization["Adj Close"].std() / 10,
                self.df_visualization["Adj Close"].max()
                + self.df_visualization["Adj Close"].std() / 3,
            ),
        )
        ...
        self.fig_action.update_yaxes(
            title_text="Price & Trading Action",
            secondary_y=False,
            showgrid=False,
            showline=False,
        )
    ...
    def technical_analysis_graph(self):
        ...
        self.fig_analysis.append_trace(
            go.Scatter(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["MACD"],
                name="MACD",
        ...
        self.fig_analysis.append_trace(
            go.Scatter(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["MACDS"],
                name="MACDS",
        ...
        self.fig_analysis.append_trace(
            go.Bar(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["MACDH"],
                name="MACDH",
                opacity=0.3,
                marker=dict(color="#000000"),
            ),
        ...
        self.fig_analysis.add_shape(
            type="line",
            x0=self.df_visualization_technical.index.min(),
        ...
        self.fig_analysis.append_trace(
            go.Scatter(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["SR_RSI_K"],
        ...
        self.fig_analysis.append_trace(
            go.Scatter(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["SR_RSI_D"],
        ...
        self.fig_analysis.append_trace(
            go.Scatter(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["RSI"],
                name="RSI",
        ...
        self.fig_analysis.append_trace(
            go.Scatter(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["SR_K"],
                name="Stochastic K",
                marker=dict(color="#F39C12"),
            ),
            row=4,
        ...
        self.fig_analysis.append_trace(
            go.Scatter(
                x=self.df_visualization_technical.index,
                y=self.df_visualization_technical["SR_D"],
                name="Stochastic D",
                marker=dict(color="#3780BF"),
            ),
            row=4,
        ...
        self.fig_analysis.update_layout(
            autosize=False,
            height=750,
            dragmode=False,
            hovermode="x",
        ...
        self.fig_analysis.update_yaxes(
            title_text="Stochastic RSI",
            range=[-1, 101],
            tickvals=[0, 20, 80, 100],
            row=2,
            col=1,
        )
        self.fig_analysis.update_yaxes(
            title_text="RSI", range=[0, 100], tickvals=[0, 30, 70, 100], row=3, col=1
        )
        self.fig_analysis.update_yaxes(
